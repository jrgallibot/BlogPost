...
from .views import BlogPostView, BlogPostDeleteView, BlogPostCreateView, BlogPostUpdateView, CommentListView, CommentCreateView, \
    BlogPostDetailView
...
urlpatterns = [
    ...
    path('blogposts/delete/<int:pk>/', BlogPostDeleteView.as_view(), name='blogpost-delete'),
